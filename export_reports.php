...
$methodChartConfig = [
    ...
    'data'=>[
        'labels'=>$methodsList,
        'datasets'=>[['label'=>'Clients','data'=>$methodData,'backgroundColor'=>'#0f8f5f']]
    ]
];
...
$serviceChartConfig = [
    ...
    'data'=>[
        ...
        'datasets'=>[['data'=>$serviceData,'backgroundColor'=>['#3b82f6','#22c55e','#ef4444','#f59e0b','#8b5cf6','#ec4899']]]
    ]
];
...
$barangayChartConfig = [
    ...
    'data'=>[
        'labels'=>$barangays,
        'datasets'=>[['label'=>'Clients','data'=>$barangayData,'backgroundColor'=>'#0f8f5f']]
    ]
];
